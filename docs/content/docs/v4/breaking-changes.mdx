...
Other websites including Coursera, Bilibili, and similar platforms are no longer supported for embedding and playback in v4. These will be addressed with the upcoming browser connect feature.
...
<Callout type="warn">
Migration will run on all notes containing any of the following fields: `media`, `video`, or `audio`. 
