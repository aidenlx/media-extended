...
You can set up hotkeys in `Settings > Hotkeys` by searching for "Media Extended". For a full list of available actions, see the [Command Reference](/docs/v4/reference/commands).
...
For a complete list of all supported hash properties and their usage, including timestamp/time range format and other playback control properties, see the [Hash Properties Reference](/docs/v4/reference/hash-props).
